...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<CoursesEntity>[] is M) {
      return data.map<CoursesEntity>((Map<String, dynamic> e) =>
          CoursesEntity.fromJson(e)).toList() as M;
    }
    if (<Courses>[] is M) {
      return data.map<Courses>((Map<String, dynamic> e) =>
          Courses.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (CoursesEntity).toString(): CoursesEntity.fromJson,
    (Courses).toString(): Courses.fromJson,
  };
